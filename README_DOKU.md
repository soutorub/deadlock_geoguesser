...
- Was war an der App sofort verständlich?
  - Runden-Erstellung und Spielstart waren klar.
  - Die Map war schnell verständlich.
  - Profil und Highscores waren gut erkennbar.

- Was war unklar oder verwirrend?
  - Die Navigation war teilweise nicht sofort klar.
  - "Spiel starten" klingt etwas so, als würde das Spiel direkt beginnen.
  - Die Unterschiede zwischen Profil-Scores und globalen Highscores waren nicht sofort klar.
  
- Welche Aufgabe war am einfachsten?
  - Login und Sign up waren einfach.
  - Eine neue Runde erstellen war einfach.
  - Die Highscore-Seite öffnen war einfach.

- Bei welcher Aufgabe hattest du am meisten Unsicherheit?
  - Beim Spielen selbst, weil der Timer eher unauffällig ist.
  - Beim ersten Guess auf der Map war nicht sofort klar, was genau bestätigt werden muss.
  - Beim Filtern im Profil musste ich kurz überlegen, welche Auswahl was verändert.

Die konkreten Antworten der Testpersonen müssen im Nachhinein noch eingefüllt werden.
